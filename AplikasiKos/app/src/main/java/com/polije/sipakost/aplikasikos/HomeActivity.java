...
import static com.polije.sipakost.aplikasikos.R.id.textLevel;

public class HomeActivity extends AppCompatActivity {
    TextView textEmail, textLevel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btCariKos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this, TampilKosActivity.class));
            }
        });
